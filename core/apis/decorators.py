...
def authenticate_principal(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        """this error will handel in server.py.
        beacause authenticate_principal execute after blueprint route decoretor
        and blueprint throw error autometicly if no such api present"""
